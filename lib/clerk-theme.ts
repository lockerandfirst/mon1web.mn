export const clerkAppearance = {
  ...
  elements: {
    ...
    modalContent:
      "overflow-hidden border border-white/70 bg-white/90 shadow-[0_36px_80px_-28px_rgba(42,0,255,0.38)] backdrop-blur-xl",
    card: "rounded-[2rem] border border-[#f4ddea] bg-white/95 shadow-[0_28px_70px_-30px_rgba(42,0,255,0.32)]",
    headerTitle: "text-3xl font-black tracking-tight text-[#2a00ff]",
    headerSubtitle: "text-sm font-medium text-[#a25691]",
    socialButtonsBlockButton:
      "h-12 rounded-2xl border border-[#dcd3ff] bg-[#f8f6ff] text-[#2a00ff] shadow-none transition-all hover:-translate-y-0.5 hover:border-[#ff9cd5] hover:bg-white",
    ...
    formFieldInput:
      "h-12 rounded-2xl border border-[#eadcf3] bg-white/90 text-[#2a00ff] shadow-[0_16px_30px_-24px_rgba(42,0,255,0.55)] placeholder:text-[#d48abd] focus:border-[#2a00ff] focus:ring-4 focus:ring-[#2a00ff]/10",
    formFieldInputShowPasswordButton:
      "text-[#ff3bad] hover:text-[#2a00ff]",
    formButtonPrimary:
      "h-12 rounded-2xl border-0 bg-brand-gradient text-sm font-black text-white shadow-[0_22px_40px_-20px_rgba(42,0,255,0.58)] transition-transform hover:-translate-y-0.5 hover:opacity-95",
    footerActionLink: "font-black text-[#ff3bad] hover:text-[#2a00ff]",
    formResendCodeLink: "font-black text-[#ff3bad] hover:text-[#2a00ff]",
    otpCodeFieldInput:
      "h-12 w-12 rounded-2xl border border-[#dcd3ff] bg-white text-[#2a00ff] shadow-none",
    alternativeMethodsBlockButton:
      "rounded-2xl border border-[#dcd3ff] bg-white text-[#2a00ff] hover:border-[#ff9cd5] hover:bg-[#fff6fb]",
    identityPreviewEditButton: "font-black text-[#ff3bad] hover:text-[#2a00ff]",
    alert:
      "rounded-2xl border border-[#ffd0e8] bg-[#fff5fb] text-[#b42372] shadow-none",
    alertText: "text-sm font-medium",
    footerAction: "text-sm text-[#8f4d88]",
    userButtonAvatarBox:
      "h-10 w-10 rounded-2xl ring-2 ring-white shadow-[0_14px_30px_-18px_rgba(42,0,255,0.5)]",
    userButtonPopoverCard:
      "overflow-hidden rounded-[1.5rem] border border-white/70 bg-white/95 shadow-[0_24px_60px_-24px_rgba(42,0,255,0.34)] backdrop-blur-xl",
    userButtonPopoverActionButton:
      "rounded-xl text-[#2a00ff] hover:bg-[#f7f4ff] hover:text-[#ff3bad]",
