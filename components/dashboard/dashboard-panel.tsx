    ...
    <div className="min-h-screen bg-[#fff9fd]">
      <div className="container mx-auto mt-16 px-3 py-5 pb-24 md:mt-18 md:px-4 md:py-8 md:pb-10">
        ...
        <Tabs defaultValue="listings" className="space-y-3 md:space-y-6">
          <TabsList className="inline-flex h-auto w-fit justify-start rounded-xl border border-[#eeebff] bg-white p-1 shadow-sm md:rounded-2xl md:p-1.5">
            <TabsTrigger
              value="listings"
              className="flex-none gap-1.5 rounded-lg px-3 py-1.5 font-black text-[9px] uppercase tracking-wide text-[#ff3bad] transition-all data-[state=active]:bg-[#2a00ff] data-[state=active]:text-white md:gap-2 md:rounded-xl md:px-4 md:py-2 md:text-[10px] md:tracking-widest"
            >
          ...
          <TabsContent value="listings" className="mt-2 md:mt-3">
            <Card className="overflow-hidden rounded-3xl border-none bg-white shadow-xl shadow-[#2a00ff]/5 md:rounded-[2.5rem] md:shadow-2xl">
              <CardHeader className="p-3 max-md:pb-2 md:border-b md:border-[#fff1f9] md:p-8">
                <div className="flex flex-col justify-between gap-2 md:gap-4 md:flex-row md:items-center">
                  ...
                  <div className="relative w-full md:w-80">
                    <Search className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-[#ff3bad] md:left-4 md:h-4 md:w-4" />
                    <Input
                      placeholder="Хайх..."
                      className="h-10 rounded-xl border-none bg-slate-50 pl-9 text-sm font-bold md:h-12 md:pl-12"
                      value={searchQuery}
